                    ...
                    <div class="titleAndSelect">
                        ...
                        <div class="selectorB4uAuto">
                            ...
                            <select name="sort" id="sortSelect" class="selectCustom">
                                ...
                                <option
                                        value="brands.title" <?php echo isset($_GET['orderBy']) && $_GET['orderBy'] == 'brands.title' ? 'selected' : '' ?>>
                                    Merk, Model, Uitvoering
                                </option>
                                <option
                                        value="mileages.mileage" <?php echo isset($_GET['orderBy']) && $_GET['orderBy'] == 'mileages.mileage' ? 'selected' : '' ?>>
                                    Kilometerstand
                                </option>
                                <option
                                        value="datumGeplaatst" <?php echo isset($_GET['sort']) && $_GET['sort'] == 'datumGeplaatst' ? 'selected' : '' ?>>
                                    Publicatiedatum
                                </option>
                                <option
