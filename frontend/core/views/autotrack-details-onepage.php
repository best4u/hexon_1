...
<div class="overview_gridWrapp">
                    ...
                    <div class="detailPage">
                        ...
                        <?php if(!empty($options)): ?>
                            <div class="omschriving">
                                ...
                                <?php if(isset($options->general) && count($options->general) > 0): ?>
                                    <h2>Meer opties</h2>
                                    <ul>
                                        <?php foreach($options->general as $option): ?>
                                            <li><?=$option->name?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>
                            ...
                            <div class="optionsAccesories">
                                <?php if((isset($options->lightning) && count($options->lightning) > 0) || (isset($options->exterior) && count($options->exterior) > 0) || (isset($options->safety_technology) && count($options->safety_technology) > 0) || (isset($options->audio_telephony) &&  count($options->audio_telephony) > 0) || (isset($options->interior_comfort)  && count($options->interior_comfort) > 0)): ?>
                                    <hr class="lineAll">
                                    <h3 class="carDetailTitle optAccTitle">Opties en Accessoires</h3>
                                <?php endif; ?>
                                <div class="descOptAcc">
                                    <?php if (isset($options->lightning) &&  count($options->lightning) > 0) : ?>
                                        <div class="optieAccItem">
                                            <h4 class="carDetailSubtitle">Verlichting</h4>
                                            <ul class="commList commDesc text_color">
                                                <?php foreach($options->lightning as $option): ?>
                                                    <li><?=$option->name?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (isset($options->exterior) && count($options->exterior) > 0) : ?>
                                        <div class="optieAccItem">
                                            <h4 class="carDetailSubtitle">Exterieur</h4>
                                            <ul class="commList commDesc text_color">
                                                <?php foreach($options->exterior as $option): ?>
                                                    <li><?=$option->name?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (isset($options->safety_technology) && count($options->safety_technology) > 0) : ?>
                                        <div class="optieAccItem">
                                            <h4 class="carDetailSubtitle">Veiligheid en Techniek</h4>
                                            <ul class="commList commDesc text_color">
                                                <?php foreach($options->safety_technology as $option): ?>
                                                    <li><?=$option->name?></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (isset($options->audio_telephony) &&  count($options->audio_telephony) > 0) : ?>
                                        <div class="optieAccItem">
                                            <h4 class="carDetailSubtitle">Audio / Telefonie</h4>
                                            <ul class="commList commDesc text_color">
                                               <?php foreach($options->audio_telephony as $option): ?>
                                                <li><?=$option->name?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                    <?php endif; ?>
                                    <?php if (isset($options->interior_comfort)  && count($options->interior_comfort) > 0) : ?>
                                        <div class="optieAccItem">
                                            <h4 class="carDetailSubtitle">Interieur en Comfort</h4>
                                            <ul class="commList commDesc text_color">
                                             <?php foreach($options->interior_comfort as $option): ?>
                                                <li><?=$option->name?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                        ...
                        <div class="specificatiesBlock">
                            ...
                            <div class="descSpecificaties">
                                <?php if(count($carsService->getDetailsTotalAttr('algemeen')) > 0): ?>
                                    <h4 class="carDetailSubtitle">Algemeen</h4>
                                    <div class="descAlgemen commDesc text_color">
                                        <div class="commLeftSpecific between">
                                            <?php foreach($carsService->getDetailsTotalAttr('algemeen') as $attr): ?>
                                                ...
                                                <?php endif; ?>
                                            <?php endforeach; ?>
                                        </div><!-- /.commLeftSpecific -->
                                    </div>
                                <?php endif; ?>
                            </div>
                            <?php if(count($carsService->getDetailsTotalAttr('aflevering')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">AFLEVERING</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('geschiedenis')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">GESCHIEDENIS VAN DEZE AUTO</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('matenEnGewichten')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">MATEN EN GEWICHTEN</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('milieu')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">MILIEU</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('motor')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">MOTOR</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('prestaties')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">PRESTATIES</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($carsService->getDetailsTotalAttr('onderstel')) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">ONDERSTEL</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                            ...
                            <?php if(count($car->data->guarantees->items) > 0): ?>
                                <hr class="lineAll">
                                <h4 class="carDetailSubtitle">Garanties en zekerheden</h4>
                                <div class="descAlgemen commDesc text_color">
                                    <div class="commLeftSpecific between">
                                        <ul class="commList commDesc text_color">
    ...
    </div><!-- /.leftAndRightWrapp -->
</div><!-- /.overview_gridWrapp -->
